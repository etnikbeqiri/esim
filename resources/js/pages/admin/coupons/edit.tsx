...
import { type BreadcrumbItem, type Country, type Coupon, type Package, type Provider } from '@/types';
...
export default function EditCoupon({ coupon, countries, providers, packages }: Props) {
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    {coupon.usage_count} uses {coupon.usage_limit ? `/ ${coupon.usage_limit}` : '(unlimited)'}
                                </p>
                            </div>
                            {coupon.usage_limit && (
                                <div className="text-right">
                                    <div className="text-2xl font-bold">{Math.round((coupon.usage_count / coupon.usage_limit) * 100)}%</div>
