        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="mx-auto w-full max-w-5xl space-y-6 px-4">
                            ...
                            <div className="rounded-lg border">
                                <div className="divide-y">
                                    ...
                                    <div className="flex items-center justify-between px-4 py-3">
                                        ...
                                        <span className="text-sm font-medium">
                                            €
                                            {analytics.total_discount_given.toFixed(
                                                2,
                                            )}
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between px-4 py-3">
                                        ...
                                        <span className="text-sm font-medium text-green-600">
                                            €
                                            {analytics.total_revenue_generated.toFixed(
                                                2,
                                            )}
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between px-4 py-3">
                                        ...
                                        <span className="text-sm font-medium">
                                            €
                                            {analytics.average_order_value.toFixed(
                                                2,
                                            )}
                                        </span>
                                    </div>
                    ...
                    <div>
                        <h2 className="mb-4 text-sm font-medium">
                            Recent Usages ({analytics.total_usages})
                        </h2>
                        <div className="rounded-lg border">
                                            ...
                                            >
                                                <TableCell>
                                                    {usage.customer ? (
                                                        <div>
                                                            <Link
                                                                href={`/admin/customers/${usage.customer.id}`}
                                                ...
                                                <TableCell>
                                                    {usage.order ? (
                                                        <Link
                                                            href={`/admin/orders/${usage.order.uuid}`}
                                ...
                                <div className="divide-y rounded-lg border">
                                    {analytics.top_customers.map((tc) => (
                                        ...
                                        >
                                            <div>
                                                <Link
                                                    href={`/admin/customers/${tc.customer_id}`}
                                                    className="font-medium hover:underline"
                                                >
                                                    {tc.customer
                                                        ?.company_name ||
